...
public class DuplicateCharacters {
    ...
    public static char[] getDuplicates(String inputString){
        ...
        return uniqueCharactersString.toCharArray();
    }
    ...
    public static void main(String[] args) {
        ...
        try(Scanner sc = new Scanner(System.in)){
            ...
            char[] resultString = getDuplicates(inputString);
            System.out.println("Duplicate characters are : "+ Arrays.toString(resultString));
        }
    }
}
